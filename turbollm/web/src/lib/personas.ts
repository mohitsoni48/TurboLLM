...
const TURBOLLM_KNOWLEDGE =
  ...
  '- **Stats row under a Code session** reads `Think <budget> · Context <%> of <max> · Last turn ↑<prompt> ↓<generated> · <n> tok/s`, identical for the built-in agent and a CLI one. The tok/s figure is the engine\'s own measured generation rate, not throughput averaged over the whole round trip.\n\n' +
